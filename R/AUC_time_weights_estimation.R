...
#'
#' **Lagrange method:** (see \code{\link[AUCtest]{AUC_Lagrange_Cjp_coefficients}} for the definition of the Cjp coefficients)
...
#' 
#' **Spline method:**  (see \code{\link[AUCtest]{AUC_Spline_matrix_A}} and \code{\link[AUCtest]{AUC_Spline_matrix_B}} for the definition of Matrices A and B)
