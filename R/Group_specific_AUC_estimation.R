...
#' \code{Model_estimation} \tab either the vector of the marginal parameter estimates (at least for the groups whose AUC is to estimate), or a list containing this vector labeled _'beta'_ among other arguments (see \link[AUCtest]{MEM_Polynomial_Group_structure} for details about the parameter order). \cr
