...
#' \code{Delta_AUC} \tab the estimated value of the difference of AUC between the two groups (nAUC2 - nAUC1) (see \code{\link[AUCtest]{Group_specific_Delta_AUC_estimation}} for more details). \cr
#' \code{AUCs} \tab the estimated values of the Group-specific AUC (AUC1 and AUC 2)  (see \code{\link[AUCtest]{Group_specific_AUC_estimation}} for more details). \cr
#' }
#' 
#' @examples 
#' # Download of data
...
#'  \code{\link[AUCtest]{Group_specific_Delta_AUC_estimation}},
